...
const now = new Date();
const getRandomMinutesFromNow = (min: number, max: number) =>
  new Date(now.getTime() + (min + Math.random() * (max - min)) * 60 * 1000);
...
const testPools = [
  {
    ...
    description:
      "Bitcoin has been on a bull run this year. Will it reach the milestone of $150,000 by December 31st, 2024?",
    tag: "crypto",
  ...
  },
  {
    ...
    description:
      "After last season's performance, will the Los Angeles Lakers secure a playoff spot in the 2024-25 NBA season?",
    tag: "sports",
  ...
  {
    title:
      "Will AI replace more than 30% of software engineering jobs by 2026?",
    description:
      "With the rapid advancement of AI coding tools, will artificial intelligence replace over 30% of traditional software engineering positions by 2026?",
    tag: "technology",
  ...
  },
  {
    ...
    description:
      "Tesla's stock has been volatile this year. Will TSLA reach $500 per share before January 1st, 2025?",
    tag: "finance",
  ...
  },
  {
    ...
    description:
      "California sits on several fault lines. Will there be a major earthquake of magnitude 7.0 or higher in California before the end of 2024?",
    tag: "weather",
  ...
  },
  {
    ...
    description:
      "Elon Musk has set ambitious goals for Mars colonization. Will SpaceX achieve a successful human landing on Mars by 2030?",
    tag: "space",
    deadline: getOneDayFromNow(),
    image:
  ...
  },
  {
    ...
    description:
      "Netflix continues to expand globally. Will they surpass 300 million subscribers worldwide by the end of 2025?",
    tag: "entertainment",
    deadline: getOneDayFromNow(),
    image:
  ...
  },
  {
    ...
    description:
      "Post-pandemic work trends are still evolving. Will more than 50% of major tech companies adopt permanent remote work policies by 2025?",
    tag: "business",
